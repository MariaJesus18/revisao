...
<body>
    ...
    <div class="pt-5">
        <div class="navbar fixed-top navbar-expand-lg navbar-light" style="background-color: #FEC5BB">
            <div class="container">
                <a href="{{url('/tasks')}}" class="navbar-brand">TodoList</a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-todo">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="{{ url('/tasks') }}">Home</a>
                        </li>
                        @can('is-admin')
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="{{ url('/tasks/create')}}">Create</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="#" id="navbarScrollingDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">                                
                                <img src="{{asset('img-resource/avatar.png')}}" class="rounded-circle border border-2" width="32px">
                            </a>                            
